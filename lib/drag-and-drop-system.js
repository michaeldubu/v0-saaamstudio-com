...
class DragAndDropSystem {
  constructor() {
    ...
    // Only initialize if we're in the browser and DOM is ready
  ...
  initialize() {
    // Double check we're in the browser and not already initialized
    if (typeof window === "undefined" || typeof document === "undefined" || this.isInitialized) {
      return
    }
  ...
  setupGlobalEventListeners() {
    // Safety check for document and initialization state
...
// Global instance - only create if in browser, but don't initialize immediately
